<div class="container p-4 mx-auto">
    <div class="p-4 text-white bg-gray-800 rounded-t-lg">
        <h1 class="mb-4 text-3xl font-bold">Mon Panier</h1>
    </div>
    <div id="panier" class="flex flex-wrap justify-center gap-4 p-4">
        <!-- Les produits du panier seront ajoutés ici dynamiquement -->
    </div>
    <div class="p-4 text-white bg-gray-800 rounded-b-lg">
        <p class="mb-4 text-xl font-bold">Total : <span id="total">0</span> €</p>
...
<script>
    ...
    function afficherPanier() {
        ...
        if (panier.length === 0) {
            ...
            panierContainer.innerHTML = "<p class='text-center text-gray-700'>Votre panier est vide.</p>";
            ...
            panier.forEach((produit, index) => {
                ...
                html += `
                    <div class="w-full p-4 bg-white rounded-lg shadow-md md:w-1/2 lg:w-1/3 xl:w-1/4">
